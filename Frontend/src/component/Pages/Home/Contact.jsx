  ...
  return (
    <section id="contact" className="py-16 sm:py-20">
      <Container className="grid gap-8 sm:gap-12 items-start -mt-8 sm:-mt-12 md:-mt-12 lg:-mt-12 -mb-10 sm:-mb-10 md:-mb-18 lg:-mb-10 text-center ">
        <div>
          <h3 className="text-3xl sm:text-4xl lg:text-4xl  font-semibold leading-tight mb-4 sm:mb-6 text-white/80">
            Ready to Grow Your Revenue Through Digital Marketing?
          </h3>

          <div className="text-3xl sm:text-xl lg:mx-25  mb-4 sm:mb-6 text-white/80">
            <h2>
